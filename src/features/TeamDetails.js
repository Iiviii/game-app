    ...
    <div>
      {teamDetails ? (
        <Card>
          ...
          <p>
            Full name:
            <ImportantInfoColor>{teamDetails.full_name}</ImportantInfoColor>
          </p>
          <p>
            City: <ImportantInfoColor>{teamDetails.city}</ImportantInfoColor>
          </p>
          <p>
            Abbreviation:
            <ImportantInfoColor>
          ...
          <p>
            Division:
            <ImportantInfoColor>{teamDetails.division}</ImportantInfoColor>
          </p>
          <p>
            Conference:
            <ImportantInfoColor>{teamDetails.conference}</ImportantInfoColor>
          </p>
        </Card>
      ) : (
        <Spinner />
